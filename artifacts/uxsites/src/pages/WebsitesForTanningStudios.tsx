    ...
    <>
      <SEO title="Websites for Tanning Studios | UX Sites Shropshire" description="Showcase your tanning results and attract more bookings with a fresh, professional website. Built for spray tan and sunbed studios across Shropshire." url="https://uxsites.co.uk/websites-for-tanning-studios/" schema={[
        ...
        faqSchema([
          ...
          { question: "How much does a tanning studio website cost?", answer: "New websites start from £1,500. If you need a gallery, price list, and online booking, we'll give you a fixed quote upfront." },
      ...
      <main>
        <HeroBlock tagline="Tanning studio websites" headline="Websites for Tanning Studios and Spray Tan Technicians" subheadline="Your tanning results sell themselves — your website just needs to show them off. We build beautiful, mobile-friendly sites that showcase your work and make booking effortless." primaryCta={{ text: "Start Your Project", href: "/contact" }} secondaryCta={{ text: "See Our Work", href: "/work" }} chips={["Results Gallery", "Price Lists", "Online Booking", "Mobile First", "Local SEO"]} />
