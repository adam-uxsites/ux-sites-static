...
const painPoints = [
  ...
  { title: "Different clients need different messages", description: "Retirement planning, investments, mortgages, protection â€” each service area speaks to a different need. Clear, dedicated pages help potential clients self-identify and reach out with confidence." },
