  ...
  return (
    <>
      <SEO title="Websites for Medium-Sized Businesses | UX Sites Shropshire" description="A corporate website that matches your ambition. Multi-department sites with professional design, built for established mid-sized companies across Shropshire." url="https://uxsites.co.uk/websites-for-medium-businesses/" schema={[
        ...
        faqSchema([
          { question: "Our team is busy running the business â€” who manages our website?", answer: "We do. Our managed hosting service (Â£50/month) covers updates, security, backups, and performance. Your site runs itself while your team focuses on your business." },
          ...
          { question: "How much does a medium business website cost?", answer: "New websites start from Â£1,500. For multi-department sites with team pages and case studies, we'll give you a fixed quote based on your scope." },
      ...
      <main>
        <HeroBlock tagline="Medium business websites" headline="Websites for Medium Businesses and Established Companies" subheadline="Your business has grown â€” your website should reflect your success. We build professional, multi-department sites that showcase your company's strengths." primaryCta={{ text: "Start Your Project", href: "/contact/" }} secondaryCta={{ text: "See Our Work", href: "/work/" }} chips={["Multi-Department", "Corporate Design", "Team Profiles", "Mobile First", "Case Studies"]} />
        <section className="py-24 bg-card border-y border-border">
          <div className="container mx-auto px-4 max-w-6xl"><div className="text-center mb-16"><h2 className="text-3xl md:text-4xl font-bold mb-4">Why medium businesses need a website that reflects their scale</h2><p className="text-muted-foreground text-lg max-w-3xl mx-auto">Your business has achieved real scale â€” your website should show it. Here's what makes a great medium business website.</p></div>
        ...
        <BenefitsGrid title="How We Help Your Medium Business" subtitle="Beyond the website â€” we keep your online presence running smoothly." benefits={[
