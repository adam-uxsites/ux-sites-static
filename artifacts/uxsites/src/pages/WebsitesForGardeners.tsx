  ...
  return (
    <>
      <SEO title="Websites for Gardeners & Grounds Maintenance | UX Sites Shropshire" description="A simple, effective website for gardeners and grounds maintenance businesses. Get found locally, showcase your work, and make it easy for customers across Shropshire to get a quote." url="https://uxsites.co.uk/websites-for-gardeners/" schema={[
        ...
        faqSchema([
          { question: "I'm busy working outdoors â€” who manages my website?", answer: "We do. Our managed hosting service (£50/month) covers updates, security, backups, and performance. Your site runs itself while you focus on your gardens." },
      ...
      <main>
        <HeroBlock tagline="Gardener websites" headline="Websites for Gardeners and Grounds Maintenance" subheadline="Your transformations speak for themselves â€” your website should show them. We build beautiful, mobile-friendly sites that showcase your work and help clients find you." primaryCta={{ text: "Start Your Project", href: "/contact/" }} secondaryCta={{ text: "See Our Work", href: "/case-studies/" }} chips={["Before & After", "Service Areas", "Seasonal Offers", "Mobile First", "Quote Forms"]} />
