  ...
  return (
    <>
      <SEO title="Websites for Gardeners & Grounds Maintenance | UX Sites Shropshire" description="A simple, effective website for gardeners and grounds maintenance businesses. Get found locally, showcase your work, and make it easy for customers across Shropshire to get a quote." url="https://uxsites.co.uk/websites-for-gardeners/" schema={[
        ...
        faqSchema([
          { question: "I'm busy working outdoors â€” who manages my website?", answer: "We do. Our managed hosting service (Â£50/month) covers updates, security, backups, and performance. Your site runs itself while you focus on your gardens." },
          ...
          { question: "How much does a gardener's website cost?", answer: "New websites start from Â£1,500. If you need a portfolio, service list, and service areas, we'll give you a fixed quote upfront." },
      ...
      <main>
        <HeroBlock tagline="Gardener websites" headline="Websites for Gardeners and Grounds Maintenance" subheadline="Your transformations speak for themselves â€” your website should show them. We build beautiful, mobile-friendly sites that showcase your work and help clients find you." primaryCta={{ text: "Start Your Project", href: "/contact/" }} secondaryCta={{ text: "See Our Work", href: "/work/" }} chips={["Before & After", "Service Areas", "Seasonal Offers", "Mobile First", "Quote Forms"]} />
        <section className="py-24 bg-card border-y border-border">
          <div className="container mx-auto px-4 max-w-6xl"><div className="text-center mb-16"><h2 className="text-3xl md:text-4xl font-bold mb-4">Why gardeners need a website that grows your business</h2><p className="text-muted-foreground text-lg max-w-3xl mx-auto">Your work transforms gardens â€” your website should help you find more clients. Here's what makes a great gardener's website.</p></div>
        ...
        <BenefitsGrid title="How We Help Your Gardening Business" subtitle="Beyond the website â€” we keep your online presence running smoothly." benefits={[
          { title: "Managed WordPress Hosting", description: "Â£50/month covers hosting, daily backups, security monitoring, updates, and ongoing support. Your site runs itself while you focus on your gardens." },
          { title: "New Website Builds", description: "From Â£1,500. A fully custom website designed to showcase your work and attract more clients." },
