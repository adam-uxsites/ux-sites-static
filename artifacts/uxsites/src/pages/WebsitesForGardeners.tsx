...
export default function WebsitesForGardeners() {
  return (
    <>
      ...
      <main>
        <HeroBlock tagline="Gardener websites" headline="Websites for Gardeners and Grounds Maintenance" subheadline="Your transformations speak for themselves — your website should show them. We build beautiful, mobile-friendly sites that showcase your work and help clients find you." primaryCta={{ text: "Start Your Project", href: "/contact" }} secondaryCta={{ text: "See Our Work", href: "/work" }} chips={["Before & After", "Service Areas", "Seasonal Offers", "Mobile First", "Quote Forms"]} />
