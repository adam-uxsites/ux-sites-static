...
const painPoints = [
  ...
  { title: "Parent information reduces admin burden", description: "Term dates, uniform information, meal menus, and policies â€” putting all parent resources online reduces phone calls and admin time for your staff." },
