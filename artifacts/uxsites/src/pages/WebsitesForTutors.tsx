  ...
  return (
    <>
      ...
      <main>
        ...
        <BenefitsGrid title="How We Help Your Tutoring Business" subtitle="Beyond the website — we keep your online presence running smoothly." benefits={[
