    ...
    <>
      <SEO title="Websites for Takeaways & Fast Food | UX Sites Shropshire" description="Get more online orders with a takeaway website built for speed. Menus, online ordering, and local SEO  -  designed for takeaways and fast food across Shropshire." url="https://uxsites.co.uk/websites-for-takeaways/" schema={[
        ...
        faqSchema([
          ...
          { question: "How much does a takeaway website cost?", answer: "New websites start from £1,500. If you need a menu, online ordering, and delivery information, we'll give you a fixed quote upfront." },
      ...
      <main>
        <HeroBlock tagline="Takeaway websites" headline="Websites for Takeaways, Delivery, and Fast Food" subheadline="Your food speaks for itself — your website just needs to make ordering easy. We build mobile-friendly sites with clear menus and simple online ordering." primaryCta={{ text: "Start Your Project", href: "/contact/" }} secondaryCta={{ text: "See Our Work", href: "/case-studies/" }} chips={["Online Ordering", "Digital Menu", "Delivery Checker", "Mobile First", "Local SEO"]} />
        <section className="py-24 bg-card border-y border-border">
          <div className="container mx-auto px-4 max-w-6xl"><div className="text-center mb-16"><h2 className="text-3xl md:text-4xl font-bold mb-4">Why takeaways need a website that makes ordering easy</h2><p className="text-muted-foreground text-lg max-w-3xl mx-auto">Your food sells itself — but only if customers can order it easily. Here's what makes a great takeaway website.</p></div>
        ...
        <BenefitsGrid title="How We Help Your Takeaway" subtitle="Beyond the website — we keep your online presence running smoothly." benefits={[
          ...
          { title: "New Website Builds", description: "From £1,500. A fully custom website designed to showcase your menu and drive online orders." },
          ...
          { title: "Menu Update Service", description: "We can manage your menu updates for you — price changes, new items, and special offers handled as part of your hosting plan." }
        ]} />
        <FAQBlock faqs={[
          { question: "I'm busy cooking — who manages my website?", answer: "We do. Our managed hosting service (£50/month) covers updates, security, backups, and performance. Your site runs itself while you focus on your food." },
          { question: "Can customers order directly through the website?", answer: "Yes. We can integrate an online ordering system or link to your preferred delivery platform so customers can order directly from your site." },
