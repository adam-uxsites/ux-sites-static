      ...
      <SEO
        ...
        schema={[
          ...
          faqSchema([
            ...
            { question: "How is it different from what I currently have?", answer: "Most standard hosting (GoDaddy, Bluehost, SiteGround basic) requires you to manage your own WordPress updates, security, and backups. If your site gets hacked or breaks, you're dealing with it yourself  -  or paying for emergency support. Our managed plan means none of that is your problem." },
            { question: "Can you migrate my existing site?", answer: "Yes. We handle the complete migration process  -  WordPress files, database, any email accounts, and DNS management. Migration is always free  -  there's no charge regardless of which plan you're on. We maintain zero downtime during the transfer." },
