                ...
                return (
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">The problem</div>
                        <p className="text-sm text-muted-foreground leading-relaxed">{item.problem}</p>
                      </div>
                      <div className="border-t border-border pt-3">
                        <div className="text-xs font-bold text-primary uppercase tracking-wider mb-1">What we do</div>
              ...
              {[
                ...
                >
                  ...
                  <div className="space-y-3 text-sm">
                    <div>
                      <div className="text-xs text-muted-foreground font-semibold mb-1">Measures</div>
                      <p className="text-muted-foreground">{vital.what}</p>
                    </div>
                    <div>
                      <div className="text-xs text-muted-foreground font-semibold mb-1">Good score</div>
                      <p className="text-primary font-semibold">{vital.good}</p>
                    </div>
                    <div>
                      <div className="text-xs text-muted-foreground font-semibold mb-1">Typical problem</div>
                      <p className="text-muted-foreground">{vital.typical}</p>
                    </div>
                    <div className="border-t border-border pt-3">
                      <div className="text-xs text-muted-foreground font-semibold mb-1">How we fix it</div>
