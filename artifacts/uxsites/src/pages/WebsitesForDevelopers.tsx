...
const painPoints = [
  ...
  { title: "Local knowledge is your selling point", description: "Property development is hyper-local â€” knowing the area, the planning authority, and the local market is a huge advantage. Your website should reinforce that you're a local developer who understands the community." },
  { title: "From small builds to large estates â€” one site can cover it all", description: "Whether you're a sole developer doing one project at a time or a company with multiple sites, your website needs to scale. We build sites that grow with your portfolio, from a single project page to a full development showcase." }
];
