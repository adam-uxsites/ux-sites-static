...
const painPoints = [
  { title: "Your property listings are your product", description: "For estate agents, the website is your shop window. Property listings with high-quality photos, floor plans, and key details are the core of what you do — they need to look professional and be easy to browse." },
  ...
  { title: "Local knowledge is your differentiator", description: "Estate agency is hyper-local. Your website should demonstrate your knowledge of the area — school catchments, transport links, local amenities — and rank for local property searches." },
    ...
    <>
      <SEO title="Websites for Estate Agents | UX Sites Shropshire" description="Dominate local property search with a website built for estate agents. Showcase listings, attract vendors, and generate more instructions across Shropshire." url="https://uxsites.co.uk/websites-for-estate-agents/" schema={[
        ...
        faqSchema([
          ...
          { question: "I'm setting up my own agency — can I get a professional website quickly?", answer: "Yes. We can create a professional site with your branding, area coverage, and initial listings to help you launch looking established and ready to compete." }
        ])
      ]} />
      <main>
        ...
        <BenefitsGrid title="How We Help Your Agency" subtitle="Beyond the website — we keep your online presence running smoothly." benefits={[
