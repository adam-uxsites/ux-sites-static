...
const painPoints = [
  { title: "Your work is visual â€” your site should sell it", description: "Hairdressing is about skill and style. A gallery of your cuts, colours, and styling work shows potential clients the quality they can expect and helps them choose you over other salons." },
  { title: "Clients book online â€” or they book elsewhere", description: "Most salon clients expect to book online. Your website needs clear pricing, service menus, and an easy booking flow that works on mobile so clients can book anytime." },
  ...
  { title: "Your brand sets the tone before they arrive", description: "Your website is the first impression of your salon. The colours, imagery, and feel of your site should reflect your salon's atmosphere â€” whether that's premium, edgy, or friendly." },
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid lg:grid-cols-2 gap-14 items-start">
              <div><h2 className="text-3xl md:text-4xl font-bold mb-6">What a great salon website includes</h2><p className="text-muted-foreground text-lg leading-relaxed mb-6">A salon website needs to attract, inform, and convert â€” all while looking as good as the work you do. We build sites that do all three.</p><p className="text-muted-foreground leading-relaxed mb-8">Whether you run a busy high street salon, a freelance studio, or a barbershop, we structure your site around your services and your clients.</p><Link href="/new-website/" className="inline-flex items-center justify-center rounded-lg bg-primary text-primary-foreground px-6 py-3 text-sm font-bold hover:opacity-90 transition-opacity">See our full website process</Link></div>
