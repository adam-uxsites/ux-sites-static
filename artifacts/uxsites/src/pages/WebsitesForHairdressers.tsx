...
const painPoints = [
  { title: "Your work is visual — your site should sell it", description: "Hairdressing is about skill and style. A gallery of your cuts, colours, and styling work shows potential clients the quality they can expect and helps them choose you over other salons." },
  { title: "Clients book online — or they book elsewhere", description: "Most salon clients expect to book online. Your website needs clear pricing, service menus, and an easy booking flow that works on mobile so clients can book anytime." },
  { title: "Local search drives local clients", description: "People search for 'hairdresser near me' or 'salon in [town]' when they need a cut or colour. Local SEO helps you show up when potential clients in your area are looking." },
  { title: "Your brand sets the tone before they arrive", description: "Your website is the first impression of your salon. The colours, imagery, and feel of your site should reflect your salon's atmosphere — whether that's premium, edgy, or friendly." },
  { title: "New salons need to build a client base fast", description: "If you're opening a new salon or starting as a freelance stylist, a professional website helps you attract your first clients and look established from day one." }
];
    ...
    <>
      <SEO title="Websites for Hairdressers & Salons | UX Sites Shropshire" description="Fill your appointment book with a website that showcases your work. Online booking, gallery, and pricing  -  built for hairdressers, barbers, and salons across Shropshire." url="https://uxsites.co.uk/websites-for-hairdressers" schema={[
        ...
        faqSchema([
          ...
          { question: "My current site doesn't reflect the quality of my work. Can you help?", answer: "Yes. We can redesign your site with a strong visual focus — galleries, before-and-after shots, and a design that matches your salon's brand and atmosphere." }
        ])
      ]} />
      <main>
        ...
        <BenefitsGrid title="How We Help Your Salon Business" subtitle="Beyond the website — we keep your online presence running smoothly." benefits={[
