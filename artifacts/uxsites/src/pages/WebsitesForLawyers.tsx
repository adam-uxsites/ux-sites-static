...
const painPoints = [
  ...
  { title: "Practice area clarity reduces wasted enquiries", description: "Conveyancing, family law, personal injury, commercial â€” each practice area serves different clients. Clear, separate pages for each area help the right enquiries reach you and filter out mismatches." },
  ...
  { title: "Local reputation needs online backing", description: "Legal work is often local â€” clients want a solicitor who knows the area. Your website should reinforce your local presence and rank for searches in the towns you serve." },
