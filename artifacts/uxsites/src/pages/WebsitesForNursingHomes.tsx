...
const painPoints = [
  ...
  { title: "Virtual tours help families from afar", description: "Many families live outside the local area. Virtual tours or extensive photo galleries of your facilities help them get a真实 sense of your home before visiting." },
