  ...
  return (
    <>
      <SEO
        ...
        description="Managed WordPress hosting & care plans from Â£50â€“Â£500/month. Daily backups, real-time security, expert support â€” no technical headaches. Google UX Certified."
      ...
      <main>
        <HeroBlock 
          ...
          subheadline="From Â£50/month managed hosting to full-service care plans at Â£250 or Â£500/month  â€”  hosting, updates, security, development, and expert support included. Focus on running your business while we handle your website."
          primaryCta={{ text: "Managed Hosting", href: "/managed-wordpress-hosting/" }}
          secondaryCta={{ text: "View Care Plans", href: "/wordpress-care-plan/" }}
          chips={["Managed Hosting Â£50/mo", "Care Plan Â£250/mo", "Care Plan Pro Â£500/mo", "Security & Backups", "Expert Support", "Content Updates", "Performance Optimised", "Uptime Monitoring"]}
        />
