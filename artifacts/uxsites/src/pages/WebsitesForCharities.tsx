  ...
  return (
    <>
      <SEO title="Websites for Charities & Non-Profits | UX Sites Shropshire" description="Tell your story, attract donors, and grow your impact. A website built for charities and non-profits across Shropshire and the Welsh borders." url="https://uxsites.co.uk/websites-for-charities/" schema={[
        ...
        faqSchema([
          { question: "Our charity team is small â€” who manages our website?", answer: "We do. Our managed hosting service (Â£50/month) covers updates, security, backups, and performance. Your site runs itself while your team focuses on your cause." },
          ...
          { question: "How much does a charity website cost?", answer: "New websites start from Â£1,500. If you need donation pages, volunteer sign-up, and news sections, we'll give you a fixed quote upfront." },
      ...
      <main>
        <HeroBlock tagline="Charity websites" headline="Websites for Charities and Community Groups" subheadline="Your cause matters â€” your website should make people care. We build professional, mobile-friendly sites that tell your story and inspire support." primaryCta={{ text: "Start Your Project", href: "/contact/" }} secondaryCta={{ text: "See Our Work", href: "/work/" }} chips={["Donation Pages", "Volunteer Sign-up", "Impact Stories", "Mobile First", "News & Events"]} />
        <section className="py-24 bg-card border-y border-border">
          <div className="container mx-auto px-4 max-w-6xl"><div className="text-center mb-16"><h2 className="text-3xl md:text-4xl font-bold mb-4">Why charities need a website that inspires action</h2><p className="text-muted-foreground text-lg max-w-3xl mx-auto">Your cause changes lives â€” your website should help people join you. Here's what makes a great charity website.</p></div>
        ...
        <BenefitsGrid title="How We Help Your Charity" subtitle="Beyond the website â€” we keep your online presence running smoothly." benefits={[
          { title: "Managed WordPress Hosting", description: "Â£50/month covers hosting, daily backups, security monitoring, updates, and ongoing support. Your site runs itself while your team focuses on your cause." },
          { title: "New Website Builds", description: "From Â£1,500. A fully custom website designed to tell your story and inspire support." },
