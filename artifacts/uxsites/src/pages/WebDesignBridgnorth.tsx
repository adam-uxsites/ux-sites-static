        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-14 items-start">
              <div>
                <h2 className="text-3xl font-bold mb-6">Industries We Work With Across the Bridgnorth Area</h2>
                <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                  Bridgnorth and the surrounding area has a diverse business economy - from town centre retail and professional services to agriculture, hospitality and manufacturing. Whatever sector you're in, your website should reflect the way your Bridgnorth customers search and buy.
                </p>
