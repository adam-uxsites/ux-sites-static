...
const auditPhases = [
  {
    ...
    icon: BarChart3,
    title: "Data Analysis",
    description: "We review your analytics data — user flows, drop-off points, page performance, device breakdowns, and conversion paths — to identify where visitors are getting stuck or leaving."
  },
  {
    number: "02",
    icon: MousePointer,
  ...
  },
  {
    ...
    description: "A systematic evaluation of your site against UX best practices — navigation clarity, information architecture, form design, mobile usability, accessibility, and conversion path logic."
  },
  {
    number: "04",
    icon: Lightbulb,
    title: "Recommendations Report",
    description: "A clear, prioritised report of issues found and specific recommendations — ranked by impact and effort. You'll know exactly what to fix and in what order."
  }
];

const findings = [
  "Users aren't completing your contact forms — and you don't know why",
  ...
  "Your navigation structure confuses people — they can't find what they need",
...
export default function WebsiteUXAudit() {
  return (
    <>
      ...
      <main>
        <HeroBlock
          tagline="It's in the name — UX"
          headline="Website UX Audit — Find Out Why Visitors Aren't Converting"
          subheadline="Most websites lose 70-90% of visitors without a trace. A UX audit reveals exactly where people get stuck, what confuses them, and what to fix — prioritised by impact."
          ...
          <div className="section-wrap">
            <div className="section-header">
              ...
              <p className="subhead-section">
                A combination of data analysis, user behaviour research, and usability expertise — giving you a complete picture of what's working and what isn't.
              </p>
            </div>
            ...
            <div className="grid-split">
              <div>
                ...
                <p className="body-lg mb-6">
                  Most web designers build websites based on what looks good. We build based on what works — because years of analysing user behaviour data has shown us that good looking doesn't always mean effective.
                </p>
                <p className="body-lg mb-6">
                  Before founding UX Sites, I worked as a UX Analyst — running user testing sessions, analysing behaviour data, optimising conversion funnels, and implementing tracking to measure real outcomes. That experience shapes every website we build and every recommendation we make.
                </p>
                <p className="body-lg mb-8">
                  A UX audit applies that same analytical approach to your existing site — identifying the friction points that are losing you visitors, and giving you a clear, prioritised plan to fix them.
                </p>
                <Link
                  href="/about"
              ...
              <div className="card-base p-7">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Specific, evidence-backed issues — not vague 'improve the UX' advice",
                    ...
                    "A roadmap for improvements — whether you do them or we do"
                  ].map((item, i) => (
        ...
        <BenefitsGrid
          ...
          benefits={[
            ...
            { title: "Customer Behaviour Insights", description: "Understand what your visitors actually want — not what you assume they want. Data removes the guesswork." },
            { title: "Prioritised Action Plan", description: "Not a vague report — you'll know exactly what to fix and in what order, ranked by impact and effort." },
            ...
            { title: "Accessibility Check", description: "Basic accessibility review included — ensuring your site works for all users, not just some." }
          ]}
        />
        ...
        <FAQBlock
          faqs={[
            {
              question: "I already have Google Analytics — doesn't that tell me what's happening?",
              answer: "GA4 tells you what users do (which pages they visit, where they drop off) but not why. A UX audit combines analytics data with behaviour research — heatmaps, session recordings, and usability testing — to explain the reasons behind the numbers."
            },
            {
            ...
            },
            {
              ...
              answer: "For new sites, we apply UX principles during the design and build process. For existing sites, we audit what's there — identifying specific problems and recommending fixes. Both approaches are informed by the same UX analysis background."
            }
          ]}
        />
        ...
        <CTABanner
          ...
          description="Get in touch and we'll discuss a UX audit for your website. Free initial consultation — we'll tell you if an audit is the right move."
