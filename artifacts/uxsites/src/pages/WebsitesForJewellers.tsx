...
const painPoints = [
  { title: "Your work is art â€” your website should show it", description: "Jewellery is visual and detailed. A high-quality gallery of your pieces helps potential customers appreciate your craftsmanship and choose you over mass-market retailers." },
  ...
  return (
    <>
      <SEO title="Websites for Jewellers & Jewellery Designers | UX Sites Shropshire" description="A beautiful website for jewellers, makers, and designers. Showcase your craftsmanship, tell your brand story, and attract more customers across Shropshire." url="https://uxsites.co.uk/websites-for-jewellers/" schema={[
        ...
        faqSchema([
          { question: "I'm busy making and selling â€” who manages my website?", answer: "We do. Our managed hosting service (Â£50/month) covers updates, security, backups, and performance. Your site runs itself while you focus on your craft." },
          ...
          { question: "How much does a jeweller's website cost?", answer: "New websites start from Â£1,500. If you need a portfolio, commission page, and repair services, we'll give you a fixed quote upfront." },
      ...
      <main>
        ...
        <section className="py-24 bg-card border-y border-border">
          <div className="container mx-auto px-4 max-w-6xl"><div className="text-center mb-16"><h2 className="text-3xl md:text-4xl font-bold mb-4">Why jewellers need a website that showcases craftsmanship</h2><p className="text-muted-foreground text-lg max-w-3xl mx-auto">Your work is detailed and beautiful â€” your website should reflect that. Here's what makes a great jeweller's website.</p></div>
        ...
        <BenefitsGrid title="How We Help Your Jewellery Business" subtitle="Beyond the website â€” we keep your online presence running smoothly." benefits={[
          { title: "Managed WordPress Hosting", description: "Â£50/month covers hosting, daily backups, security monitoring, updates, and ongoing support. Your site runs itself while you focus on your craft." },
          { title: "New Website Builds", description: "From Â£1,500. A fully custom website designed to showcase your jewellery and attract more customers." },
