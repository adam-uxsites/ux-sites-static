        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid md:grid-cols-2 gap-14 items-start">
              <div>
                <h2 className="text-3xl font-bold mb-6">Industries We've Served Across the Shrewsbury Area</h2>
                <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                  Shrewsbury has a diverse business economy - from town centre professional services and independent retail to healthcare, hospitality and manufacturing across the surrounding area. We've built websites across all of these.
                </p>
