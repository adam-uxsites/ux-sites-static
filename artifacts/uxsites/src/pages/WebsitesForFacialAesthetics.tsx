...
export default function WebsitesForFacialAesthetics() {
  return (
    <>
      ...
      <main>
        <HeroBlock tagline="Aesthetic clinic websites" headline="Websites for Facial Aesthetics and Aesthetic Clinics" subheadline="Your results speak for themselves — your website should make sure people see them. We build beautiful, mobile-friendly sites that showcase your treatments and make it easy for clients to book consultations." primaryCta={{ text: "Start Your Project", href: "/contact" }} secondaryCta={{ text: "See Our Work", href: "/work" }} chips={["Before & After Galleries", "Consultation Booking", "Mobile First", "Local SEO", "Ongoing Support"]} />
