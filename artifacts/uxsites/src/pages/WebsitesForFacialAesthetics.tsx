...
export default function WebsitesForFacialAesthetics() {
  return (
    <>
      ...
      <main>
        <HeroBlock tagline="Aesthetic clinic websites" headline="Websites for Facial Aesthetics and Aesthetic Clinics" subheadline="Your results speak for themselves — your website should make sure people see them. We build beautiful, mobile-friendly sites that showcase your treatments and make it easy for clients to book consultations." primaryCta={{ text: "Start Your Project", href: "/contact/" }} secondaryCta={{ text: "See Our Work", href: "/case-studies/" }} chips={["Before & After Galleries", "Consultation Booking", "Mobile First", "Local SEO", "Ongoing Support"]} />
        <section className="py-24 bg-card border-y border-border">
          <div className="container mx-auto px-4 max-w-6xl"><div className="text-center mb-16"><h2 className="text-3xl md:text-4xl font-bold mb-4">Why aesthetic clinics need a website that converts</h2><p className="text-muted-foreground text-lg max-w-3xl mx-auto">Your treatments deliver visible results — your website needs to show them. Here's what makes a great aesthetics website.</p></div>
        ...
        <BenefitsGrid title="How We Help Your Aesthetics Practice" subtitle="Beyond the website — we keep your online presence running smoothly." benefits={[
