...
const painPoints = [
  { title: "Your product range deserves a showcase", description: "From prime cuts to sausages and pies, your products are what bring customers in. A well-presented online showcase helps customers see what you offer before they visit." },
  { title: "Sourcing stories build customer trust", description: "Customers care about where their meat comes from. Your farm origins, welfare standards, and sourcing philosophy help build trust and justify premium prices." },
  { title: "Online ordering expands your reach", description: "More customers want to order meat online for delivery or collection. An online shop or order system lets you serve customers beyond your local area." },
  { title: "Local search connects you with local customers", description: "People search for 'butcher near me' or 'farm shop in [town]' when they want quality meat. Local SEO helps you appear in those searches." },
  { title: "Farm shops need to tell their story", description: "If you run a farm shop, your story is part of your brand. Your website should showcase your farm, your values, and the journey from field to plate." }
];
  ...
  return (
    <>
      <SEO title="Websites for Butchers & Farm Shops | UX Sites Shropshire" description="Showcase your quality produce and attract more customers. A website built for butchers, farm shops, and meat retailers across Shropshire and the Welsh borders." url="https://uxsites.co.uk/websites-for-butchers/" schema={[
        ...
        faqSchema([
          { question: "I'm busy in the shop â€” who manages my website?", answer: "We do. Our managed hosting service (£50/month) covers updates, security, backups, and performance. Your site runs itself while you focus on your customers." },
          ...
          { question: "How much does a butcher's website cost?", answer: "New websites start from £1,500. If you need a product showcase, sourcing story, and online ordering, we'll give you a fixed quote upfront." },
          { question: "Can I update my product range and prices myself?", answer: "Yes. We build your site so you can easily update products, prices, and special offers yourself. Or we can do it for you as part of our managed service." },
          { question: "How can I show my meat sourcing and welfare standards?", answer: "We can create a dedicated 'our story' or 'sourcing' page that explains your farming partnerships, welfare standards, and what makes your meat special." }
        ])
      ]} />
      <main>
        <HeroBlock tagline="Butcher and farm shop websites" headline="Websites for Butchers, Farm Shops, and Meat Retailers" subheadline="Your quality speaks for itself â€” your website should show it. We build beautiful, mobile-friendly sites that showcase your products and tell your story." primaryCta={{ text: "Start Your Project", href: "/contact/" }} secondaryCta={{ text: "See Our Work", href: "/case-studies/" }} chips={["Product Showcase", "Online Ordering", "Sourcing Story", "Mobile First", "Local SEO"]} />
        <section className="py-24 bg-card border-y border-border">
          <div className="container mx-auto px-4 max-w-6xl"><div className="text-center mb-16"><h2 className="text-3xl md:text-4xl font-bold mb-4">Why butchers need a website that showcases quality</h2><p className="text-muted-foreground text-lg max-w-3xl mx-auto">Your products and reputation speak volumes â€” your website should amplify them. Here's what makes a great butcher's website.</p></div>
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid lg:grid-cols-2 gap-14 items-start">
              <div><h2 className="text-3xl md:text-4xl font-bold mb-6">What a great butcher's website includes</h2><p className="text-muted-foreground text-lg leading-relaxed mb-6">A butcher's website needs to showcase quality, build trust, and make ordering easy. We build sites that do all three.</p><p className="text-muted-foreground leading-relaxed mb-8">Whether you run a traditional high street butcher or a farm shop, we structure your site around your products and your customers.</p><Link href="/new-website/" className="inline-flex items-center justify-center rounded-lg bg-primary text-primary-foreground px-6 py-3 text-sm font-bold hover:opacity-90 transition-opacity">See our full website process</Link></div>
              <div className="grid gap-3">{["Product range showcase with descriptions", "Online ordering or click-and-collect system", "Sourcing and farming story page", "Seasonal specials and meat boxes", "Customer testimonials and reviews", "Mobile-friendly design for browsing on the go"].map((item, i) => (<motion.div key={i} initial={{ opacity: 0, x: 10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.04 }} className="flex items-center gap-3 p-4 bg-card border border-border rounded-xl"><div className="w-5 h-5 rounded-full bg-primary flex items-center justify-center shrink-0"><Check size={12} className="text-primary-foreground" strokeWidth={3} /></div><span className="font-semibold text-sm">{item}</span></motion.div>))}</div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-14"><h2 className="text-3xl md:text-4xl font-bold mb-4">Related Food & Retail</h2><p className="text-muted-foreground text-lg max-w-2xl mx-auto">Other food and retail businesses with similar website needs.</p></div>
        ...
        <BenefitsGrid title="How We Help Your Butchery Business" subtitle="Beyond the website â€” we keep your online presence running smoothly." benefits={[
          ...
          { title: "New Website Builds", description: "From £1,500. A fully custom website designed to showcase your products and tell your story." },
          { title: "Existing Site Refreshes", description: "Your current site not reflecting your quality? We can redesign with a stronger product focus and better ordering flow." },
          { title: "Online Order Setup", description: "We can set up an online ordering system so customers can order meat for collection or delivery." }
        ]} />
        <FAQBlock faqs={[
          { question: "I'm busy in the shop â€” who manages my website?", answer: "We do. Our managed hosting service (£50/month) covers updates, security, backups, and performance. Your site runs itself while you focus on your customers." },
          { question: "Can customers order meat for delivery online?", answer: "Yes. We can add an online ordering system or a simple enquiry form so customers can place orders for collection or delivery." },
        ...
        <CTABanner title="Let's build your butcher's website" description="Get a free, no-obligation quote. We'll talk through your products and your story." buttonText="Get a Free Quote" buttonHref="/contact/" secondaryButtonText="See Our Process" secondaryButtonHref="/new-website/" />
